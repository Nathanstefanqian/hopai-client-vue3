<template>
  <div class="photographer">
    ...
    <div class="photographer-tag">
      <div class="photographer-tag-item">
        <image :src="netConfig.picURL + '/static/home/newbee.svg'" class="tag" />
        <span>摄影新秀</span>
      </div>
      <div class="photographer-tag-item">
        <image :src="netConfig.picURL + '/static/home/expert.svg'" class="tag" />
        <span>摄影专家</span>
      </div>
      <div class="photographer-tag-item">
        <image :src="netConfig.picURL + '/static/home/master.svg'" class="tag" />
        <span>摄影大师</span>
      </div>
    </div>
