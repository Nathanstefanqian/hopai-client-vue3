    ...
    <div class="spu-layout">
      <div class="spu-main">
        ...
        <div class="spu-desc">
          ...
          <div class="spu-desc-content" v-else>
            <image v-for="(url, index) in serviceUrls" :key="index" :src="url" mode="widthFix" class="desc-image w-100vw" />
          </div>
          <div class="spu-footer-blank"></div>
        </div>
      </div>
    </div>
