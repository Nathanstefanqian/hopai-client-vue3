<template>
  <div class="refund">
    <div class="refund-item">
      <div class="refund-item-header"> <span class="required">*</span>退款原因 </div>
    ...
    <div class="refund-item">
      ...
      <textarea v-model="formData.reasonInfo" class="refund-item-input" placeholder="请输入退款描述（200字以内）" maxlength="200"></textarea>
    ...
    <up-picker :show="showPicker" :columns="[reasonOptions.map(item => item.label)]" confirm-color="#ba2636" @close="showPicker = false" @confirm="confirmPicker"></up-picker>
  </div>
</template>
